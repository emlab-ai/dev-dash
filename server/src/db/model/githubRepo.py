from sqlalchemy import BigInteger, Boolean, Column, ForeignKey, ForeignKeyConstraint, Integer, String
from . import Base
...
class GithubRepo(Base):
    ...
    def __init__(self, id, tenant_id, org_id, node_id, name, full_name, private, deleted=False):
        self.id = id
