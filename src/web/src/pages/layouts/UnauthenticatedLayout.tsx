import { Box, Button, Flex, HStack, Heading, Text, useColorModeValue } from '@chakra-ui/react'
    ...
    <>
      ...
      <Flex as="nav" alignItems="center" justifyContent="space-between" h='16' py='2.5' pr="2.5">
        <HStack spacing={2}>
          ...
          <Heading as='h1' size="md">emlab.ai</Heading>
        </HStack>
        <HStack spacing="1">
          <ThemeToggle />
          ...
          <Box width="100%" h="calc(100vh - 64px)" position="relative">            
            <Container maxW={'4xl'}>
              <Stack
                ...
                <Text color={'gray.500'}>
                  Revolutionary platform designed specifically for Engineering Managers. Our platform integrates data from various sources, providing you with a comprehensive overview of your projects, teams, and tasks.
                </Text>
                <Stack
                  direction={'column'}
                  spacing={3}
