...
export function UserStatsDetailsDrawer({ isOpen, onClose, userId }: UserDetailsDrawerProps) {
    return (
        <UserDetailsProvider id={userId}>
            <UserStatsDetailsDrawerContent isOpen={isOpen} onClose={onClose} userId={userId} />
        </UserDetailsProvider>
    );
}

function UserStatsDetailsDrawerContent({ isOpen, onClose, userId }: UserDetailsDrawerProps) {
    ...
    >
        ...
        <DrawerContent>
            ...
            <DrawerBody overflowY="scroll">
                <UserStatsDetailsContent userId={userId} />
            </DrawerBody>            
        </DrawerContent>
    </Drawer>
}

function UserStatsDetailsContent({ userId }: { userId?: number }) {
