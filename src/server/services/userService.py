...
class UsersService:
    ...
    def get_github_user_for_manager_ids(self, tenant_id:int, user_ids:List[int])->List[int]:
    ...
    def get_user_details(self, tenant_id:int, git_user_id:int, start_date:datetime, end_date:datetime):
        ...
        prs_count = prRepository.get_count_by_date_user(tenant_id, git_user_id, start_date, end_date)
        reviewRepository = PullRequestReviewRepository(self.session)
        reviews_count = reviewRepository.get_count_by_date_user(tenant_id, git_user_id, start_date, end_date)
