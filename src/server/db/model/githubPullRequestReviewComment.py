from sqlalchemy import BigInteger, Boolean, Column, ForeignKey, String, Date, Integer, Text
...
class GithubPullRequestReviewComment(Base):
    ...
    def __init__(self, tenant_id, org_id, node_id, thread_id, pr_review_id, commit_id, is_resolved, is_outdated, author, author_id, reactions_count, created_at, updated_at, pr_id, pr_number, repo_id, body, author_association, id=None):
        self.id = id
