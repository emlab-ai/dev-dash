...
class RepoSettingsRepository(Repository[RepoSettings]):
    ...
    def list_all(self, tenant_id:int, limit=None, after=None, before=None, sort_by:str=None, sort_order:str=None, name_filter:str=None):
        ...
        query = add_cursor_filter(RepoSettings, query, after, before, sort_by, RepoSettings.id, sort_order, group=False)
